...
#' Example https://api.geonames.org/astergdem?lat=50.01&lng=10.2&username=demo 
#' @docType data
#' @usage data(weather_SouthAsia)
#' @format a \code{RangedData} instance, 1 row per day.
#' @source \url{https://power.larc.nasa.gov/} and \url{https://asterweb.jpl.nasa.gov/gdem.asp} and \url{https://www.geonames.org/about.html}
NULL
