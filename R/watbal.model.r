...
watbal.weather = function(working.year=NA, working.site=NA, weather=NA)
    {
    # Rename columns to the names expected by watbal.model and watbal.update
    ...
    # RAIN and ETr columns keep their original names — no rename needed
