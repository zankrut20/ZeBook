...
#' @param PMAX : maximum number of squares
#' @param AFL : age of flower (physiological days)
#' @param AL : age of large boll (physiological days)
#' @param AOP : age of open boll (physiological days)
#' @param P1 : rate of square formation before TF
#' @param P2 : rate of square formation after TF
#' @param P3 : shedding rate before TF
#' @param P4 : shedding rate after TF
#' @param P5 : boll shedding rate
#' @param PF : maximum number of squares for rate calculations
#' @param PSF : maximum number of setting bolls for rate calculations
#' @param TSQ : time (in physiological days) of first square
#' @param P : unused parameter
#' @param PR : unused parameter
#' @param PT : unused parameter
#' @param tend : end time of simulation (in physiological days)
